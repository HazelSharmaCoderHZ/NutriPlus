...
export default function TopMenuButton() {
  ...
  return (
    <>
      ...
      {/* Menu overlay */}
      {open && (
        <div className="fixed top-16 left-4 z-40 w-50 sm:bg-white/10 bg-white border border-cyan sm:text-white text-black rounded-xl shadow-lg p-4 flex flex-col space-y-3">
